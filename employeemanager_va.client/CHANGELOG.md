...
- Create Angular project with ng: `ng new EmployeeManager_VA.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`EmployeeManager_VA.client.esproj`).
